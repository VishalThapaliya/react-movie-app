...
import Spinner from './components/Spinner.jsxr';
import MovieCard from './components/MovieCard.jsxrd';
...
const App = () => {
  ...
  const loadTrendingMovies = async () => {
    ...
    try {
      ...
      setErrorTrendingMovies(`Error fetching trending movies. Please try again later.`);
    } finally {
